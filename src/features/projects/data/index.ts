...
const RAW_PROJECTS = [
  ...
  },
  {
    slug: 'awesome-v',
    title: 'awesome-v',
    summary: 'Curated list of V resources — frameworks, tools, libraries (CC0).',
    status: 'maintained',
    visibility: 'public',
    worldId: 'v',
    featured: true,
    ...
    group: 'v',
    links: [
      { label: 'Repo', href: 'https://github.com/ulises-jeremias/awesome-v', kind: 'repo' },
  ...
  },
  {
    slug: 'rxv',
    title: 'rxv',
    summary: 'Reactive Extensions for V — experimental RxV port.',
    status: 'experimental',
    visibility: 'public',
    worldId: 'v',
    tags: ['v', 'rx', 'reactive'],
