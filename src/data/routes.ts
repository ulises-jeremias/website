...
export const routes: RouteMeta[] = [
  ...
  },
  {
    ...
    description:
      'Thin AI-native workstation: chezmoi provisioning, profiles, LLM host policy — installs Agent Toolkit rather than duplicating it.',
  ...
  },
  {
    ...
    description:
      'Portable agentic capabilities plus the runtime that executes them: skills, agents, loops, workspace, memory, DevCompanion, and swarms for every major coding assistant.',
  ...
  },
  {
    ...
    description:
      'Field notes on developer tooling, agent workflows, and open source — written from shipped work, not announcements.',
