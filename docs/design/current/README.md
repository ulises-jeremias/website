...
3. `src/data/routes.ts` defines canonical routes and the compact navigation
   projection; its unit tests lock labels and active-item behavior.
4. `docs/INTERACTIVE_DIAGRAM_SEMANTICS.md` defines the native-control contract
